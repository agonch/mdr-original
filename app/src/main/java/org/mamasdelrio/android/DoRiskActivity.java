...
public class DoRiskActivity extends AppCompatActivity implements IFormActivity {
  ...
  @Bind(R.id.risk_send) Button send;  // was a LinearLayout, causing error in DoRiskActivityTest
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // fix riskSelectOneCorrectLabels - we are missing labels, and labels are first param
